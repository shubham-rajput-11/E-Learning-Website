...
from e_learning_website.settings import *
...
def checkout(request,slug):
    ...
    ### used decoarator instead of if condition
    ...
    if action == 'create_payment':
        ...
        if error is None:
            ...
            receipt = f'LearningHub-{int(time())}'
...
def verifyPayment(request):
    if request.method == 'POST':
        ...
        try:
            ...
            return HttpResponse('<h1>Invalid Payment Details</h1>')
